...
<body>
    <div class="flex">
        <div class="bg-gray-200 w-2/5 h-screen bg-cover bg-no-repeat bg-center" style="background-image: url({{asset('images/bgCouverture2.jpg')}})">
        ...
        <div class=" w-3/5">
            ...
            <div class="w-full mt-6">
                <p class="text-center  text-sm text-gray-500">Rejoindre la communaute de plusieurs <br>  candidats. A la recherche d'emploie</p>
            </div>
