                ...
                <div class="max-w-md mx-auto">
                    ...
                    <div class="divide-y divide-gray-200">
                        <div class="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                            <form action="{{Route('savannonce')}}"  method="POST">
                            @csrf
                            <div class="flex flex-col">
                                <label class="leading-loose">Titre</label>
                                <input type="text" maxlength="55" name="titre" id="titre"
                                    class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                    placeholder="donner un titre">
                            </div>
                            <div class="flex flex-col">
                                <label class="leading-loose">Ville</label>
                                <input type="text" maxlength="20" name="ville" id="ville"
                                    class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
                                    placeholder="Ville">
                            </div>
                            <div class="flex flex-col">
                            ...
                            <div class="flex flex-col">
                                ...
                                <textarea type="text" maxlength="250" name="description" id="description"
                                    class="px-4 py-2 border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
