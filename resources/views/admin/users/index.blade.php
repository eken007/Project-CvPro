                ...
                <header class="flex justify-between items-center py-4 px-6 bg-white border-b-4 border-indigo-600">
                    ...
                    <div class="flex items-center">
                        ...
                        <div x-data="{ dropdownOpen: false }" class="relative">
                            ...
                            <div x-show="dropdownOpen"  class="fixed inset-0 h-full w-full z-10"
                            ...
                            <div class="flex flex-wrap -mx-6">
                                <div class="w-full px-6 sm:w-1/2 xl:w-1/3">
                                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                        ...
                                        <div class="mx-5">
                                            ...
                                            <div class="text-gray-500">Utilisateur</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 sm:mt-0">
                                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                        ...
                                        <div class="mx-5">
                                            <h4 class="text-2xl font-semibold text-gray-700">{{ $annonce->count() }}</h4>
                                            <div class="text-gray-500">Nombre total annonce</div>
                                        </div>
                                    </div>
                                </div>
                                <div class="w-full mt-6 px-6 sm:w-1/2 xl:w-1/3 xl:mt-0">
                                    <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white">
                                        ...
                                        <div class="mx-5">
                                            <h4 class="text-2xl font-semibold text-gray-700">{{ $createcv->count() }}</h4>
                                            <div class="text-gray-500">Total cv cree</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                            ...
                                            <tr>
                                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                    <div class="flex items-center">
                                                        ...
                                                        <div class="ml-4">
                                                            <div class="text-sm leading-5 font-medium text-gray-900">{{ $user->id }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td
                                                    ...
                                                    <a href="{{ route('admin.users.edit', $user->id) }}" class="px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">Editer</a>

                                                    @can('delete-users')
                                                    <form action="{{ route('admin.users.destroy',$user) }}" method="POST" class="inline">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button  class=" px-5 py-2 border-blue-500 border text-blue-500 rounded transition duration-300 hover:bg-blue-700 hover:text-white focus:outline-none">Supprimer</button>
                                                    </form>
                                                    @endcan
                                                </td>
                                            </tr>  
